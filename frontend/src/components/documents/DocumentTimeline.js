...
export default function DocumentTimeline({ document }) {
  const timeline = [
    ...
    },
    {
      ...
      date: document.upload_date, // Should be replaced with actual processing date from API
      icon: <FiSettings className="w-4 h-4" />,
      color: 'bg-blue-500'
    },
    {
      title: 'Analysis Completed',
      date: document.upload_date, // Should be replaced with actual completion date from API
